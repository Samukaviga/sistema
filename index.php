...
session_start();
	...
	$QuantidadeCursos = buscandoCursos($conexao);

	$QuantidadeCursosJson = json_encode($QuantidadeCursos);

	$dados = [
		'quantidade' => $QuantidadeCursos, 
		
	];
	
	// Converte os dados para JSON e os retorna
								...
								<div class="row align-items-center">
									...
									<div class="col-6">
										<ul class="chart-list-out">
											<li><span class="circle-blue"></span>Envios</li>
